...
import { fetchEvent, updateEvent, queryClient } from '../UI/http.js';
...
//const { mutate } = useMutation({
  ...
  //},
  //onSettled: (error, data, context) => {
  //  queryClient.invalidateQueries(['events', params.id], context.previousEvent);
 // }
//});
